...
if (!isset($_SESSION['log'])) {
  echo "<script>alert('ANDA HARUS LOGIN');document.location.href='login.php';</script>";
  exit;
}
?>
...
<body>
  <div class="container-fluid">
    <div class="form">
      <form method="post">
        <h1 class="h3 mb-3 fw-bold text-center mb-3">Welcome, <?= $data['nama_user'] ?> </h1>
        <h4 class="h3 mb-3 fw-bold text-center mb-3">Login pada : <?= $data['data_login'] ?> </h4>
